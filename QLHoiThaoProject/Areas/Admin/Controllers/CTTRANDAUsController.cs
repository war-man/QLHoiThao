...
{
    public class CTTRANDAUsController : BaseController
    {
        ...
        public ActionResult Edit(int? id) {//id ma tran dau
            ...
            ViewData["diemdoi1"] = "";
            ViewData["diemdoi2"] = "";
            for (int a=0;a < cttran.Count-1;a++) {
                ViewData["tisodoi1"] = cttran[a].TISO;
                ViewData["tisodoi2"] = cttran[a+1].TISO;
                ViewData["diemdoi1"] = cttran[a].DIEM;
                ViewData["diemdoi2"] = cttran[a + 1].DIEM;
            }
            return View();
        }
